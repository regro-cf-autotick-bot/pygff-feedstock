...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/pygff-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/pygff-feedstock)
...
Once the `conda-forge` channel has been enabled, `pygff` can be installed with:

```
conda install pygff
```

It is possible to list all of the versions of `pygff` available on your platform with:
